...
public class VetClinicTest {
    ...
    public void removeClient() throws Exception {
        ...
        Client c=new Client("William Doe");
        vet.removeClient(c);
    ...
    public void equalsTest() throws UserException {
        Procedure p1=new Procedure("Temp", 10);
        Procedure p2=new Procedure("Temp", 10);
        assertEquals(true, p1.equals(p2));

        Pet pet1=new Pet("J","Cat");
        Pet pet2=new Pet("J","Cat");
        ...
        Client a= new Client("James");
        Client b= new Client("James");
